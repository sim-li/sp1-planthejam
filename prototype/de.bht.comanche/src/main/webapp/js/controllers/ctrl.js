...
angular.module('myApp')
    .controller('ctrl', ['$scope', '$rootScope', '$log', 'Survey', 'TimeUnit', 'Type', 'patterns', 'dialogMap', 'User',
        function($scope, $rootScope, $log, Survey, TimeUnit, Type, patterns, dialogMap, User) {
            ...
            $scope.initSession = function() {
                $rootScope.session = {
                    ...
                    'state': {
                        ...
                        'is': function(otherVal) {
                            return otherVal === this.isVal;
                        }
                    }
                };
