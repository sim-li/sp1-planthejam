...
public class DaSurveyImpl extends DaGenericImpl<LgSurvey> implements DaSurvey {
	 ...
	 */
	@Override
	public List<LgSurvey> findByName(String name) throws NotFoundException, NoPersistentClassException, NoQueryClassException, ArgumentCountException, ArgumentTypeException {
